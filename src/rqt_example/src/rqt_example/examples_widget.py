...
class ExamplesWidget(QWidget):
    ...
    def __init__(self, node):
        ...
        self.lcdNumber_position.display(self.sub_velocity.linear.x)
        ...
        self.push_button_position.pressed.connect(self.show_position)
    ...
    # 터미널 출력
        print('Position: x={0:.2f}, yaw={1:.2f}'.format(self.sub_velocity.linear.x, self.sub_velocity.angular.z))
        
        # GUI의 lcdNumber_position에 값 표시 (예: x값)
        self.lcdNumber_position.display(self.sub_velocity.linear.x)
